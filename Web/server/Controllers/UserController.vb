...
#Region " Private Members "
        ...
        Private Function GetAvailableQuery(Optional criteria As Expression(Of Func(Of User, Boolean)) = Nothing) As IQueryable(Of User)
            ...
            Dim query = From p In Me.UserRepository.GetAll
...
#Region " Report "
        ...
        Public Function GetByProject(id As Integer) As ResponseModel
            ...
            Dim criteria As Expression(Of Func(Of User, Boolean)) = Function(x) x.ProjectMembers.Any(Function(p) p.ProjectId = id)
            Return ResponseModel.Create(HttpStatusCode.OK, GetAvailableDto(criteria))
